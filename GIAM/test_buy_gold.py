...
@test_prep
def test_incorrect_gold_by(driver, coin, val):
    driver.get('https://qa.giam.finance/cabinet/token-sale')
    time.sleep(1)
    driver.find_element(By.CLASS_NAME, coin).click()
